...
@interface StarYearViewController ()<BaseTableCanvasDataSoure,BaseTableCanvasDelegate>
@property (nonatomic,strong) NSArray *array;

@end

@implementation StarYearViewController
...
- (void)viewDidLoad
{
    ...
    self.title = @"请选择入学年份";
    _array = [NSArray arrayWithObjects:@"2010",@"2011",@"2012",@"2013",@"2014", nil];
...
{
    NSString *year = [self.array objectAtIndex:indexPath.row];
    [self popCanvasWithArgment:[NSDictionary dictionaryWithObject:year forKey:@"StartYear"]];
}
