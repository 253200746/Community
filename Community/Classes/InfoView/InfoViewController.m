...
@interface InfoViewController ()<EWPTabMenuControlDataSource,EWPTabMenuControlDelegate>
...
- (void)getTypeList
{
    ...
    [model requestDataWithParams:params success:^(id object) {
        ...
        {
            [self.typeMArray removeAllObjects];
...
{
    InfoItemViewController *itemViewController = [[InfoItemViewController alloc] init];
    itemViewController.typeData = [self.typeMArray objectAtIndex:index];
