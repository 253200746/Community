...
@interface OrganizationViewController ()<EWPTabMenuControlDataSource,EWPTabMenuControlDelegate>
...
- (void)getTypeList
{
    ...
    [params setObject:@"association" forKey:@"type"];
...
- (UIViewController *)ewpTabMenuControl:(EWPTabMenuControl *)ewpTabMenuControl tabViewOfindex:(NSInteger)index
{
    ...
    OrganizationItemViewController *itemViewController = [[OrganizationItemViewController alloc] init];
